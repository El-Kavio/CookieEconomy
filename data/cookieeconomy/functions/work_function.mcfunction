execute as @a if entity @s[scores={Work_switch_CE=0},tag=working] run scoreboard players set @s Work_switch_CE 1
...
execute as @a at @s if entity @s[tag=!work_switch,scores={Balance_CE=..5,Work_CE=3}] run playsound minecraft:entity.axolotl.idle_air master @s ~ ~ ~ 1 0.7
